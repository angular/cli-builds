...
function dynamicPathParser(options) {
    ...
    const appRoot = options.appConfig.appDir ? path.join(sourceDir, 'app') : sourceDir;
...
//# sourceMappingURL=/home/travis/build/angular/angular-cli/utilities/dynamic-path-parser.js.map